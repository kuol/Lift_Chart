...
getVars <- function(the.call) {
	...
	out <- list(yvar = yvar, xvars = xvars)
	out
}

getVars <- function(mod.obj){
  xvars <- AlteryxPredictive::getXVars2(mod.obj)
  yvar <- as.character(formula(mod.obj))[2]
